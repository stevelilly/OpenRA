# Adapted from Roland Moriz's openra-dockerfile
# Modified to build directly from the openra source repository
# https://github.com/rmoriz/openra-dockerfile
